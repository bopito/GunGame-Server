...
public class WeaponManager {
    ...
    public WeaponManager() {
        defaultWeapon = new Weapon("Pistol", 10, 100, 30, 2.0, 0.5, 12, 60); // Pistol starts with 60 reserve ammo
        addWeapon(defaultWeapon);

        addWeapon(new Weapon("Rifle", 6, 120, 25, 2.5, 0.4, 30, 120)); // Rifle starts with 120 reserve ammo
        addWeapon(new Weapon("Sniper", 25, 200, 60, 3.5, 1.5, 5, 25)); // Sniper starts with 25 reserve ammo
        addWeapon(new Weapon("Rocket Launcher", 50, 80, 30, 4.0, 2.5, 1, 10)); // Rocket Launcher starts with 10 reserve ammo
        addWeapon(new Weapon("Knife", 80, 0, 9, 0, 0.3, 0, 0)); // Knife has no ammo
    }
